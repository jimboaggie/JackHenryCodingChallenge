...
namespace SocialOpinionAPI.Services.SampledStream
{
    public class SampledStreamService
    {
        ...
        public SampledStreamService(OAuthInfo oAuth, string bearerToken)
        {
            _oAuthInfo = oAuth;
        ...
        {
            SampledStreamClient streamClient = new SampledStreamClient(_oAuthInfo.ConsumerKey, _oAuthInfo.ConsumerSecret, _bearerToken);
